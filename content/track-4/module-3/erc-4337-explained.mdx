...
<LiveProjectExample repo="Socio3" section="Account Abstraction Layer" showMetadata={false} />
...
<LiveProjectExample repo="Socio3" section="Developer Rules" showMetadata={false} />
