...
<LiveProjectExample repo="Socio3" section="Authentication Flow" showMetadata={false} />

And here's how social interactions (posts, likes, follows, tips) are routed — all gasless for Privy users:

<LiveProjectExample repo="Socio3" section="Social Interactions" showMetadata={false} />
