...
hasProject: false
realProjectSource: ""
heroProjectContribution: "Prerequisite for implementing the social Google-sign-in dApp integrations in modern AA."
---

# Why Web3 Mobile Onboarding Sucks: And the Privy Solution

If you’ve ever tried to use a Web3 application on your phone, you probably wanted to throw your phone out the window. 

The traditional mobile Web3 onboarding flow goes something like this:
1. You open Twitter on your phone and click a link to a cool new dApp.
2. The link opens in **Twitter's in-app browser**.
3. You click "Connect Wallet". A MetaMask modal pops up.
4. You click "Connect with MetaMask."
5. **Nothing happens.** 

You click again. Still nothing. You realize you need to copy the link, open the MetaMask mobile app, navigate to their clunky internal built-in browser tab, paste the link, log in again, and *then* sign the transaction. 

By the time you get to step 6, **90% of your users have abandoned your app.** This is why Web3 mobile conversion rates are notoriously awful.
