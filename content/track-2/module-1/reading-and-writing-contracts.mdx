...
<LessonImage
  src="/images/track-2/contract_read_vs_write_flow_1780630945028.png"
  alt="Solidity Read (Call) vs Write (Transaction) Flows"
  caption="Reads are read-only view calls executed locally on an RPC node for free. Writes are signed transactions that alter blockchain state, requiring gas and mining confirmation."
/>
