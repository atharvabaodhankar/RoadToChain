...
<LessonImage
  src="/images/track-2/the_graph_indexing_architecture_1780631090166.png"
  alt="The Graph Indexing & Query Architecture"
  caption="The Graph Node extracts events from blocks, translates them into entity records using custom WASM mapping logic, and hosts them as a queryable GraphQL database."
/>
