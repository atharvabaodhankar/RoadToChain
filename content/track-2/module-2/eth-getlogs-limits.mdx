...
<LessonImage
  src="/images/track-2/eth_getlogs_block_range_limits_1780630973844.png"
  alt="RPC Query Limits on eth_getLogs Range"
  caption="Public RPC nodes enforce strict block range limits (typically 2,000 to 50,000 blocks) on event log searches to prevent memory exhaustion, causing naive history queries to fail in production."
/>
