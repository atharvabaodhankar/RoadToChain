...
<LessonImage
  src="/images/track-2/three_tier_hybrid_architecture_1780630999897.png"
  alt="The Three-Tier Web3 Hybrid Architecture"
  caption="A production dApp has three layers. 99% of your code runs on the frontend and backend. The blockchain handles only the critical 1% requiring trustless verification."
/>
