...
<LessonImage
  src="/images/track-2/nextjs_redis_caching_flow_1780631049409.png"
  alt="Cache Routing Flow in Next.js API Route"
  caption="A caching resolver intercepts queries, returning cached data instantly on hits, and fetching and storing raw IPFS files on misses to build a self-populating cache."
/>
