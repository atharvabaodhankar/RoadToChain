...
<LessonImage
  src="/images/track-2/ipfs_vs_redis_caching_latency_1780631039332.png"
  alt="IPFS Gateway Latency vs Redis Cache Speed"
  caption="Because public IPFS gateways have high request overhead and network latency, full-stack Web3 apps cache JSON metadata in Redis to drop UI loading times from seconds to milliseconds."
/>
