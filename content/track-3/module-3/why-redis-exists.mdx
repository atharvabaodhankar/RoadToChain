...
<LessonImage
  src="/images/track-3/redis_cache.png"
  alt="Redis Cache Proxy Flow for Immutable IPFS Content"
  caption="Decentralized IPFS gateways have highDHT-lookup latencies (3-5s). Caching immutable, content-addressed CIDs in Redis bypasses DHT lookups for subsequent loads (80ms)."
/>
