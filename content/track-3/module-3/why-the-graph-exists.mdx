...
<LessonImage
  src="/images/track-3/the_graph_indexing.png"
  alt="How The Graph Subgraph Sync Pipeline Works"
  caption="Solidity has no native query engine. The Graph listens to emitted blockchain events and maps them via AssemblyScript handlers into an instantly queryable GraphQL database."
/>
