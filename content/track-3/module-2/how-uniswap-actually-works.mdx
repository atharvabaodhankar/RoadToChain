...
<LessonImage
  src="/images/track-3/uniswap_amm.png"
  alt="Automated Market Maker (AMM) Constant Product Model"
  caption="Uniswap replaces traditional order books with a Constant Product formula (x * y = k) Liquidity Pool, pricing assets purely on internal reserves ratio and correcting to market via arbitrage."
/>
