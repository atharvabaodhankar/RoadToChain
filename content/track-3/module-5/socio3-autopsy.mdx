...
<LessonImage
  src="/images/track-3/socio3_autopsy.png"
  alt="Socio3 V1 Direct RPC Fail vs Socio3 V2 Decoupled Production Stack"
  caption="Socio3 V1 failed by querying state arrays directly via RPC. Socio3 V2 introduces Privy authentication, paymasters, caching gateways, and subgraphs to deliver a responsive feed."
/>
...
<LiveProjectExample repo="Socio3" section="System Architecture" showMetadata={false} />

And here's how the V2 identity model actually works — the dual EOA + Smart Account system:

<LiveProjectExample repo="Socio3" section="V2 Identity Model" showMetadata={false} />
