...
<LessonImage
  src="/images/track-3/chainelect_autopsy.png"
  alt="O(n) State Loop vs O(1) Constant Time Slot Pack Defense"
  caption="Traversing arrays inside Solidity contracts scales linearly and hits Block Gas Limits. Constant-time checks and packed structures optimize operations to constant O(1)."
/>
