...
<LessonImage
  src="/images/track-3/onchain_boundaries.png"
  alt="On-Chain vs Off-Chain Data Decision Boundary"
  caption="The gas optimization boundary defines a strict split: on-chain for trust-critical signatures and fingerprint hashes, off-chain for large documents and user-facing cache details."
/>
