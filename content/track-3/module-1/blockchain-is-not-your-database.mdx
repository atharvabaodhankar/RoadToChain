...
<LessonImage
  src="/images/track-3/hybrid_storage.png"
  alt="Web3 Hybrid Enterprise Storage Architecture"
  caption="A production-grade Web3 storage stack splits data: 32-byte cryptographic proofs on-chain, large assets in IPFS, and metadata / indexes cached in Firebase / The Graph."
/>
