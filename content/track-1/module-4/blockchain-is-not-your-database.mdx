...
<LessonImage
  src="/images/track-1/blockchain_not_database_1780577385959.png"
  alt="Blockchain is NOT Your Database — Storage Cost Reality"
  caption="Storing raw files or dynamic arrays on-chain wastes massive gas; the correct pattern stores data on IPFS/Web2 and registers only a 32-byte cryptographic hash proof on-chain."
/>
