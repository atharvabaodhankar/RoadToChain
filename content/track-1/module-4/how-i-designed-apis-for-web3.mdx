...
<LessonImage
  src="/images/track-1/web3_api_ownership_model.png"
  alt="Web3 API Design — The Three-Tier Ownership Model"
  caption="Web3 APIs use a proxy backend to hide API keys from the browser, validating sessions before forwarding heavy media to IPFS and storing only light CID hashes on-chain."
/>
