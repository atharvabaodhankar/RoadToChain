...
<LessonImage
  src="/images/track-1/voting_system_architecture_1780577426517.png"
  alt="Voting System — Smart Contract Architecture"
  caption="The architecture maps the naive setup where voting logic, voter registry, and candidate stats live in unified, unbounded storage structures."
/>
