...
<LessonImage
  src="/images/track-1/gas_disaster_antipatterns_1780577437441.png"
  alt="Gas Disaster — Anti-Patterns That Break Smart Contracts"
  caption="Iterating over unbounded dynamic arrays inside write functions causes gas consumption to grow linearly until it hits the Block Gas Limit, bricking the contract."
/>
