...
<LessonImage
  src="/images/track-1/replay_attack_nonce.png"
  alt="Replay Attacks Explained"
  caption="Without unique nonces and chain IDs in signature hashes, an offline approval signature can be copied and replayed multiple times on the same or forks of the network."
/>
