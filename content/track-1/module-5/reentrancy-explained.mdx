...
<LessonImage
  src="/images/track-1/reentrancy_attack.png"
  alt="Reentrancy Attack"
  caption="A reentrancy attack occurs when a vulnerable vault sends ETH before resetting the sender's balance, allowing a malicious fallback function to recursively drain funds."
/>
