...
<LessonImage
  src="/images/track-1/beginner_security_mistakes.png"
  alt="Beginner Security Mistakes"
  caption="Using tx.origin for access control opens a phishing vulnerability where a malicious contract can proxy the owner's signature; always use msg.sender instead."
/>
