...
<LessonImage
  src="/images/track-1/evm_stack_machine_1780577344086.png"
  alt="How the EVM Executes Code — The Stack Machine"
  caption="The EVM executes bytecode opcodes using a LIFO Stack for computations, volatile Memory for temporary arrays, and persistent Storage slots for state variables."
/>
