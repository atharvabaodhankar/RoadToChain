...
<LessonImage
  src="/images/track-1/contract_lifecycle_1780577331131.png"
  alt="Smart Contract Lifecycle — Compile to Deploy to Execute"
  caption="A smart contract progresses from local Solidity code, through compilation to bytecode, mempool propagation, constructor instantiation, to permanent, passive runtime storage."
/>
