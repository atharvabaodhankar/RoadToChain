...
<LessonImage
  src="/images/track-1/abi_encoding_flow_1780577300038.png"
  alt="ABI Encoding — From Function Call to Hex Calldata"
  caption="The ABI acts as the schema translation layer, mapping human-readable frontend calls to structured hexadecimal bytes that the EVM can parse."
/>
