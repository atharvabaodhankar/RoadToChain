...
<LessonImage
  src="/images/track-1/variables_and_state_1780577125352.png"
  alt="Solidity Variables & State — Where Data Lives"
  caption="State variables are carved permanently in the blockchain ledger (expensive to write), whereas local variables exist only temporarily in the VM's cheap memory space during execution."
/>
