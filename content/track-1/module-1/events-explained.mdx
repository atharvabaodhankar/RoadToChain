...
<LessonImage
  src="/images/track-1/events_vs_storage_1780577203417.png"
  alt="Events vs Storage — What Gets Indexed Where"
  caption="Writing to storage changes the EVM state but is highly expensive; emitting events logs parameters to cheaper, indexable off-chain receipts that contracts cannot read."
/>
