...
<LessonImage
  src="/images/track-1/arrays_vs_mappings_1780577155868.png"
  alt="Arrays vs Mappings — O(N) vs O(1) Lookup"
  caption="Arrays preserve index order but require expensive linear searches, while mappings use direct slot hashing to deliver instant constant-time lookups."
/>
