...
<LessonImage
  src="/images/track-0/mainnet_vs_testnet_1780492857927.png"
  alt="Mainnet vs Testnet — economic reality, chain IDs, and value comparison"
  caption="Mainnet ETH has value because validators stake real capital, block space is scarce, and EIP-1559 burns tokens. Testnet ETH has zero value: no stakes, unlimited supply, no market, resettable."
/>
