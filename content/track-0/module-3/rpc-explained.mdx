...
<Diagram type="rpc-pipeline" caption="Your app calls an RPC endpoint (Infura, Alchemy, QuickNode), which forwards the request to a full node, which propagates it to the P2P network." />
