...
<LessonImage
  src="/images/track-0/rpc_abi_evm_1780492899017.png"
  alt="RPC, ABI, and EVM — the three invisible layers between your code and the blockchain"
  caption="ABI translates your function call into binary calldata. RPC transmits that data to a node over JSON-RPC. The EVM executes the bytecode against global state."
/>
