...
<LessonImage
  src="/images/track-0/l1_vs_l2_architecture_1780492870095.png"
  alt="L1 vs L2 architecture — how rollups bundle transactions and settle on Ethereum"
  caption="Optimistic and ZK Rollups batch hundreds of transactions off-chain, compress them, and post a single settlement proof to Ethereum L1 — splitting the gas cost across all users."
/>
