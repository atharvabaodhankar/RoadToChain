...
<Diagram type="gas-meter" caption="EVM opcodes carry different gas costs. Storage writes (SSTORE) cost ~6000x more than simple arithmetic (ADD) because storage is permanent and scarce." />
