...
<LessonImage
  src="/images/track-0/why_gas_exists_1780493034018.png"
  alt="Why gas exists — EVM opcode pricing and the infinite loop prevention mechanism"
  caption="Gas is the metering system that prevents infinite loops and DoS attacks on the shared EVM computer. Every opcode has a fixed cost; if you run out of gas, execution halts immediately."
/>
