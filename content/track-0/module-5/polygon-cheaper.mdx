...
<LessonImage
  src="/images/track-0/polygon_vs_ethereum_gas.png"
  alt="Polygon vs Ethereum gas costs — block supply, demand, and validator count comparison"
  caption="Polygon has 12x more block space supply than Ethereum and dramatically lower demand. More supply + less demand = gas prices 100–1000x cheaper, with the trade-off of fewer validators and less decentralization."
/>
