...
<Diagram type="mempool-visualizer" caption="Transactions wait in the Mempool database of validator nodes. Validators select and order transactions based on gas bid priority to pack into the next block." />
