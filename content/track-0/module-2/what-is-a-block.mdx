...
<LessonImage
  ...
  alt="Anatomy of a Block — Header fields and Body transaction list"
  caption="A block contains a Header (previous hash, merkle root, timestamp, nonce, difficulty) and a Body (ordered list of transactions). The previous hash is what chains blocks together."
/>
