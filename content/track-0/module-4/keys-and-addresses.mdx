...
<LessonImage
  src="/images/track-0/key_derivation_chain_1780492952633.png"
  alt="Key derivation chain — private key to public key to Ethereum address"
  caption="Your Ethereum identity is a chain of one-way mathematical operations: random entropy → private key → secp256k1 elliptic curve → public key → Keccak-256 hash → address."
/>
