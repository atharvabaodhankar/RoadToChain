...
<LessonImage
  src="/images/track-0/why_web3_needs_wallets.png"
  alt="Why Web3 needs wallets — identity without a server, Web2 vs Web3 identity model"
  caption="Web2 identity is granted by a server that creates a record. Web3 identity is generated locally from a keypair — your address exists mathematically before any server ever sees it."
/>
