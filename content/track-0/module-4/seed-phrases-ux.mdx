...
<LessonImage
  src="/images/track-0/seed_phrase_vs_embedded_wallet_1780493021596.png"
  alt="Seed phrase wallet vs embedded wallet — onboarding complexity comparison"
  caption="MetaMask requires downloading an app, writing 12 words on paper, funding a wallet, and switching networks. Privy embedded wallets replace all of that with a single Google OAuth tap."
/>
