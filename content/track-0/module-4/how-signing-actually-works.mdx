...
Let's talk about the **MetaMask Popup Fear.**

You visit a new dApp. You click a button, and MetaMask slides in with a prompt: *"Sign this message."*

Your stomach drops slightly. 

*Is this safe? If I click 'Sign', am I authorizing a transaction? Will this drain all my ETH? Why doesn't it show a gas estimate? How does my browser prove it's me without executing a contract?*
...
<RealityCheck>
  Many phishers exploit gasless signatures. They show you a prompt that looks like a harmless signature ("Sign in to this website") but is actually a permit signature authorizing their contract to transfer all your tokens. Always read what you are signing! If MetaMask displays a scary raw hex instead of readable data, reject it immediately.
</RealityCheck>
