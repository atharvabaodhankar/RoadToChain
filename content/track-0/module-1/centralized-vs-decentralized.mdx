...
<LessonImage
  src="/images/track-0/centralized_vs_decentralized_1780492655254.png"
  alt="Centralized vs Decentralized vs Distributed network topologies"
  caption="In centralized systems a single hub controls all nodes. In distributed P2P networks every node is both client and server — eliminating single points of failure."
/>
