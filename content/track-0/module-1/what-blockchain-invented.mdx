...
<LessonImage
  src="/images/track-0/nakamoto_consensus_1780492696740.png"
  alt="Nakamoto Consensus — combining Proof of Work with the longest chain rule"
  caption="Satoshi combined three existing primitives — P2P networking, cryptographic hashing, and economic incentives — to solve distributed consensus without a central authority."
/>
